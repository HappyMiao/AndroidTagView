...
/**
 * @className: TagListViewFlowLayout
 * @classDescription: 标签控件
 * @author: miao
 * @createTime: 2017年2月14日
 */

public class TagListViewFlowLayout extends ViewGroup {
    ...
    public TagListViewFlowLayout(Context context) {
        super(context);
        this.readStyleParameters(context, null);
    }

    public TagListViewFlowLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.readStyleParameters(context, attributeSet);
    }

    public TagListViewFlowLayout(Context context, AttributeSet attributeSet, int defStyle) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < getNum(); i++) {
            ...
            if (lp.x == 0) {
                ...
                child.layout(pre_x, lp.y, pre_x + child.getMeasuredWidth(), lp.y + child.getMeasuredHeight());
            }
